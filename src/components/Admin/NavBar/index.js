        ...
        <nav className="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div className="container-fluid">
                {/* <div className="navbar-wrapper">
                    <Link className="navbar-brand" to="javascript:;"></Link>
                </div> */}
                ...
                <div className="collapse navbar-collapse justify-content-end">
                    ...
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item dropdown">
                            <Link className="nav-link" to="http://example.com" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                <Link className="dropdown-item" to="/admin/u-profile">Profile</Link>
                                <Link className="dropdown-item" to="/admin/u-setting">Settings</Link>
                                <div className="dropdown-divider" />
                                <Link className="dropdown-item" to="/admin/login">Log in</Link>
                                <Link className="dropdown-item" to="/admin/logout">Log out</Link>
                            </div>
                        </li>
                    </ul>
                </div>
